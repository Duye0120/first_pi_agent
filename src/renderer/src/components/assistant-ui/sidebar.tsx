    ...
    return (
      <div key={summary.id} className="relative">
        <div
          ...
          className={`group flex cursor-pointer items-center rounded-[var(--radius-shell)] py-2 transition ${indented ? "pl-6 pr-2.5" : "px-3"
    ...
    <aside className="flex h-full bg-transparent flex-col text-[13px] text-foreground">
      ...
      <div className="px-3 pb-3 pt-3">
        <button
          ...
          className="flex w-full cursor-pointer items-center gap-2 rounded-[var(--radius-shell)] border border-shell-border bg-shell-panel px-3 py-2.5 text-sm font-medium text-foreground transition hover:bg-accent hover:text-accent-foreground"
        >
      ...
      <div className="border-t border-border/70 px-3 py-3">
        ...
        <button
          ...
          className="mt-1 flex w-full cursor-pointer items-center gap-2 rounded-[var(--radius-shell)] px-3 py-2 text-[12px] text-muted-foreground transition hover:bg-accent hover:text-foreground"
        >
