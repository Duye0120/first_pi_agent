...
export const AssistantUIReasoning: FC = () => {
  ...
  return (
    ...
    >
      <CollapsibleTrigger
        className={cn(
          "group/trigger inline-flex max-w-full items-center gap-2 py-1 text-left transition-colors duration-200 select-none",
      ...
      >
        <span
          className={cn(
            "shrink-0 font-mono text-[13px] font-medium leading-6 transition-colors",
            isRunning
              ? "text-[color:var(--color-accent)]"
              : "text-[color:var(--chela-text-secondary)]"
          )}
        >
          think
        </span>
